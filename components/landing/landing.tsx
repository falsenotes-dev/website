...
Unleash Your Ideas</Balancer></h1>
            ...
            <div className="landing_hero-image w-[167vw] xl:w-screen">
              <Image loading="eager" className="dark:hidden block" src="/assets/falsenotes-hero light.png" sizes="100vw" width={1920} height={711} layout="responsive"
                // Make the image display full width
                style={{
                  width: '120vw',
                  height: 'auto',
                }} alt="" />
              <Image loading="eager" className="hidden dark:block" src="/assets/falsenotes-hero dark.png" sizes="100vw" width={1920} height={711} layout="responsive"
                // Make the image display full width
                style={{
                  width: '120vw',
                  height: 'auto',
