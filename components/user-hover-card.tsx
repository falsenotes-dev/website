        ...
        <div className="flex flex-col space-y-1">
          ...
          <div className="flex items-center gap-1 w-full">
            ...
            <Button variant={"outline"} size={"sm"} className="pl-0 py-0 shadow-none border-none hover:bg-transparent">
              <span><span className="font-bold text-card-foreground">{formatNumberWithSuffix(user?.Followers?.length || user._count.Followers)}</span> <span className="text-muted-foreground ml-2">Followers</span></span>
            </Button>
            <Button variant={"outline"} size={"sm"} className="pl-0 py-0 shadow-none border-none hover:bg-transparent">
              <span><span className="font-bold text-card-foreground">{formatNumberWithSuffix(user?.Followings?.length || user._count.Followings)}</span> <span className="text-muted-foreground ml-2">Followings</span></span>
            </Button>
          </div>
