    ...
    <div className="flex flex-col w-full">
      {!isEditing ? (
        <>
                ...
                <div className="flex items-center">
                  {session ? (
                    <Button
                      ...
                      size={"icon"}
                      variant={"ghost"}
                      disabled={session?.id == comment.authorId}
          ...
          {openReply && (
            <div className="flex w-full justify-between space-y-4 before:border before:border-dashed pl-4">
      ...
      {isReplying && (
        <div className="flex w-full justify-between before:border before:border-dashed pl-4">
          <ReplyForm
            comment={comment}
            post={post}
            session={session}
